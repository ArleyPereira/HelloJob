...
import br.com.hellodev.setup.presenter.features.profile.state.SetupProfileState
import br.com.hellodev.setup.presenter.features.profile.viewmodel.SetupProfileViewModel
import org.koin.androidx.compose.koinViewModel

@Composable
fun SetupProfileScreen(
    parameter: SetupProfileParameter? = null,
    ...
    LifecycleEventEffect(event = Lifecycle.Event.ON_RESUME) {
        parameter?.let {
            viewModel.dispatchAction(
                action = SetupProfileAction.SetBackResult(it)
            )
        }
    }
...
private fun SetupProfileContent(
    ...
    action: (SetupProfileAction) -> Unit,
    navigateToCountryScreen: () -> Unit,
    navigateToGenreScreen: () -> Unit,
    onBackPressed: () -> Unit
) {
    val imagePickerLauncher = rememberLauncherForActivityResult(
        ...
        onResult = { uri ->
            action(SetupProfileAction.OnChangeImage(uri))
        }
    )
        ...
        bottomBar = {
            Column(
                ...
                PrimaryButton(
                    ...
                    onClick = { action(SetupProfileAction.Update) }
                )
            }
        },
        ...
        content = { paddingValues ->
            Column(
                ...
                TextFieldUI(
                    ...
                    onValueChange = {
                        action(SetupProfileAction.OnTextFieldChanged(it, FIRST_NAME))
                    }
                )
                ...
                TextFieldUI(
                    ...
                    onValueChange = {
                        action(SetupProfileAction.OnTextFieldChanged(it, SURNAME))
                    }
                )
                ...
                TextFieldUI(
                    ...
                    onValueChange = {
                        action(SetupProfileAction.OnTextFieldChanged(it, DATE_BIRTH))
                    }
                )
                ...
                TextFieldUI(
                    ...
                    onValueChange = {
                        action(SetupProfileAction.OnTextFieldChanged(it, EMAIL))
                    }
                )
                ...
                TextFieldUI(
                    ...
                    onValueChange = {
                        action(SetupProfileAction.OnTextFieldChanged(it, PHONE))
                    }
                )
...
@PreviewLightDark
@Composable
private fun SetupProfilePreview() {
    HelloTheme {
        SetupProfileContent(
            state = SetupProfileState(
