package br.com.hellodev.hellojob.home.presenter.screen
...
import br.com.hellodev.hellojob.home.presenter.action.HomeAction
import br.com.hellodev.hellojob.home.presenter.state.HomeState
                ...
                LazyColumn(
                    ...
                    item {
                        state.recommendation?.let {
                            HorizontalJobSectionUI(section = it)
                        }
